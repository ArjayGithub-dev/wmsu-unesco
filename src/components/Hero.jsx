    ...
    <section id="home" className={`flex flex-col md:flex-row ${styles.paddingY} justify-center items-center`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 mb-10 justify-center items-center text-center`}>
        ...
        <div className="flex flex-wrap justify-center mt-[40px]">
          <div className="relative w-[350px] h-[250px] md:w-[300px] md:h-[200px] sm:w-[250px] sm:h-[150px] rounded-lg overflow-hidden -mr-[10px] sm:-mr-[50px] mt-6 mb-6 ss:mb-0">
          ...
          <div className="relative w-[350px] h-[250px] md:w-[300px] md:h-[200px] sm:w-[250px] sm:h-[150px] rounded-lg overflow-hidden -ml-[10px] sm:-ml-[50px] z-0 mt-6">
